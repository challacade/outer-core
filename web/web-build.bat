@echo off
:: ============================================================================
:: Outer Core - Web Build Script (Windows)
::
...
::   web-build.bat /games/outer-core/ -- deploy build with explicit base path
::
...
setlocal
set PROJECT_NAME=Outer Core
set LOVE_FILE=outer-core.love
...
echo ========================================
echo Outer Core Web Build (2dengine)
echo ========================================
...
::
:: For deploy builds (BASE_HREF set, e.g. /games/outer-core/) we deliberately
