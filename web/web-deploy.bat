@echo off
:: ============================================================================
:: Outer Core - Production Deploy Build
::
:: 1. Builds the web bundle with <base href="/games/outer-core/">.
...
::    quirks:
::        web-output/outer-core.html   <- wrapper HTML (was index.html)
::        web-output/outer-core/       <- all game assets
